...
describe('eslint logical-props rule', () => {
  ...
  it('flags physical borders, radii and text alignment (inset-x is logical in v4)', () => {
    const messages = lint(
      'export const C = () => <div className="border-l border-r rounded-l rounded-r text-left text-right" />',
    )
  ...
  it('does not flag logical or symmetric utilities', () => {
    const messages = lint(
      'export const C = () => <div className="ps-4 pe-2 ms-3 me-1 px-4 py-2 mx-auto my-0 text-start border-s border-e rounded-s rounded-e inset-x-0 inset-0 gap-4 size-4" />',
    )

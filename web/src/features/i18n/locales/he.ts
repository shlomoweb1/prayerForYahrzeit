export const he = {
  ...
  wizard: {
    ...
    labels: {
      ...
      elMalehPhrase: 'נוסח "בעבור"',
      kaddishResponseLabel: 'תווית תגובת הקהל',
      kaddishAdvanced: 'הגדרות קדיש מתקדמות',
      sections: 'חלקי הדף',
      settings: 'הגדרות',
      dialog: 'חלון',
      settingsMode: 'מצב הגדרות',
      lineDensity: 'צפיפות שורות',
      fontBsd: 'בס"ד (ימין למעלה)',
      fontSheetTitle: 'כותרת ראשית',
      fontNameLine: 'שורת השם',
      fontSectionTitle: 'כותרות חלקים',
      fontPsalmBadge: 'תגית מזמור',
      ...
      fontElMalehText: 'אל מלא רחמים',
      fontHashkavaText: 'השכבה',
      fontClosingDryBones: 'חזון העצמות היבשות',
      fontClosingAvHaRachamim: 'אב הרחמים',
      fontClosingParting: 'בקשת פרידה',
    },
    groups: {
      design: 'עיצוב ופריסה',
      content: 'תוכן הדף',
      sections: 'חלקי הדף',
      fontHeader: 'כותרת הדף',
      fontPsalms: 'מזמורים',
      fontLetters: 'אותיות',
      fontKaddish: 'קדיש',
      fontMishnayot: 'משניות',
      fontPrayers: 'ברכה וסיום',
    },
    sections: {
    ...
    options: {
      ...
      elMalehPhrase: {
        charity: 'בעבור שנדבו צדקה',
        psalms: 'בעבור שאנו מתפללים לעילוי נשמתו',
      },
    ...
    dialog: {
      print: 'הדפסה',
      settings: 'הגדרות',
      kaddish: 'הגדרות קדיש מתקדמות',
      kaddishDescription: 'בחרו כיצד תודפס תגובת הקהל בקדיש.',

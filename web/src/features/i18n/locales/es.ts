...
export const es = {
  ...
  blog: {
    title: 'Blog',
    tagline: 'Notas del taller: cómo se construye este sitio',
  },
  contactPage: {
    title: 'Contacto',
    intro: '¿Buscas a alguien para construir un sistema, sitio web o proyecto? Escribe unas líneas y te responderé.',
  },
  privacyPage: {

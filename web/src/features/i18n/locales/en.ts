...
export const en = {
  ...
  wizard: {
    ...
    labels: {
      ...
      elMalehPhrase: '"בעבור" wording',
      kaddishResponseLabel: 'Congregation response label',
      kaddishAdvanced: 'Advanced kaddish settings',
      sections: 'Sheet sections',
      settings: 'Settings',
      dialog: 'Dialog',
      settingsMode: 'Settings mode',
      lineDensity: 'Line density',
      fontBsd: 'בס"ד (top right)',
      fontSheetTitle: 'Sheet title',
      fontNameLine: 'Name line',
      fontSectionTitle: 'Section headings',
      fontPsalmBadge: 'Psalm badge',
    ...
    groups: {
      ...
      sections: 'Sheet sections',
      fontHeader: 'Sheet header',
      fontPsalms: 'Psalms',
      fontLetters: 'Acrostic letters',
      fontKaddish: 'Kaddish',
      fontMishnayot: 'Mishnayot',
      fontPrayers: 'Blessing & closing',
    },
    sections: {
    ...
    options: {
      ...
      elMalehPhrase: {
        charity: 'Charity was donated',
        psalms: 'We pray for the elevation of their soul',
      },
    ...
    dialog: {
      print: 'Print',
      settings: 'Settings',
      kaddish: 'Advanced kaddish settings',
      kaddishDescription: 'Choose how the congregation’s response is printed in the kaddish.',

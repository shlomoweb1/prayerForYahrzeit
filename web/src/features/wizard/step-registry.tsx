...
import { Step4Name } from '@/features/wizard/steps/step-4-name'
import { Step5Parent } from '@/features/wizard/steps/step-5-parent'
import { Step6Split } from '@/features/wizard/steps/step-6-split'
import { Step7Review } from '@/features/wizard/steps/step-7-review'
...
export const stepRegistry: StepDefinition[] = [
  ...
  { number: 4, titleKey: 'wizard.steps.4.title', component: Step4Name },
  { number: 5, titleKey: 'wizard.steps.5.title', component: Step5Parent },
  { number: 6, titleKey: 'wizard.steps.6.title', component: Step6Split },
  { number: 7, titleKey: 'wizard.steps.7.title', component: Step7Review },
]
